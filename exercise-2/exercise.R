...
# Create a column 'got_rais e' that is TRUE if the person got a raise (their
# salary went up)
...
salary_57 <- salaries[salaries$employees == "Empolye e57", salaries_2018]
...
write.csv(salararies, 'salaries.csv')
